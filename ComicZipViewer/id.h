...
constexpr wxWindowID ID_BTN_DELETE_SELECTED_BOOKMARK = ID_BTN_ADD_MARK + 1;
constexpr wxWindowID ID_BTN_DELETE_ALL_BOOKMARK = ID_BTN_DELETE_SELECTED_BOOKMARK + 1;
constexpr wxWindowID ID_BTN_CLEAR_LATEST_READ_PAGE = ID_BTN_DELETE_ALL_BOOKMARK + 1;
