...
D2DFrame::D2DFrame(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size,
...
bool D2DFrame::Create(wxWindow* parent , wxWindowID id , const wxString& title , const wxPoint& pos , const wxSize& size ,
	long style , const wxString& name)
{
...
HRESULT D2DFrame::GetD2DDevice(ID2D1Device** ppDevice)
{
	if( ppDevice == nullptr)
	{
		return E_INVALIDARG;
...
HRESULT D2DFrame::GetD2DDeviceContext(ID2D1DeviceContext1** ppDeviceContext)
{
...
HRESULT D2DFrame::GetD3DDevice(ID3D11Device** ppDevice)
{
	if ( ppDevice == nullptr )
	{
		return E_INVALIDARG;
...
HRESULT D2DFrame::GetD3DDeviceContext(ID3D11DeviceContext** ppDeviceContext)
{
	if ( ppDeviceContext == nullptr )
	{
		return E_INVALIDARG;
...
HRESULT D2DFrame::GetSwapChain(IDXGISwapChain1** ppSwapChain)
{
...
HRESULT D2DFrame::GetD2DTargetBitmap(ID2D1Bitmap1** ppTargetBitmap)
{
...
HRESULT D2DFrame::GetD2DFactory(ID2D1Factory2** ppFactory)
{
...
HRESULT D2DFrame::ResizeSwapChain(const wxSize& size)
{
	HRESULT hRet;
...
bool D2DFrame::CreateD2DResource()
{
	HRESULT hRet;
	HWND hWnd = GetHWND();
